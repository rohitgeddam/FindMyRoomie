...
#         person_pgender.send_keys("Female")
#         person_pdegree.send_keys("PHD")
#         person_pdiet.send_keys("Veg")
#         person_pcountry.send_keys("United States of America")
#         person_pcourse.send_keys("Computer Science")
